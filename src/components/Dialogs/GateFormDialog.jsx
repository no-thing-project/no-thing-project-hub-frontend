// src/components/Dialogs/GateFormDialog.jsx
...
const GateFormDialog = ({ open, title, gate, setGate, onSave, onCancel, errorMessage }) => {
  return (
      ...
      >
        ...
        <DialogContent>
          <TextField
            ...
            sx={inputStyles}
            required
            error={!!errorMessage && errorMessage.includes("Gate")}
          />
          <TextField
            margin="normal"
            label="Description"
            ...
            onChange={(e) => setGate({ ...gate, description: e.target.value })}
            sx={inputStyles}
            multiline
            rows={3}
          />
          <Select
            ...
            onChange={(e) => setGate({ ...gate, visibility: e.target.value })}
            fullWidth
            variant="outlined"
            sx={selectStyles}
          >
